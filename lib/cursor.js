 ...
 * @return {Cursor}
 */
Cursor.prototype.sort = function(keyOrList, direction, cb) {
  var err = undefined
  try {
    var curs = new Cursor(this._cursor.sort(keyOrList, direction))
  } catch (e) {
    if (!cb) {
      throw e
    }
 ...
 * @return {Cursor}
 */
Cursor.prototype.limit = function(value, cb) {
  var err = undefined
  try {
    var curs = new Cursor(this._cursor.limit(value))
  } catch (e) {
    if (!cb) {
      throw e
    }
 ...
 * @return {Cursor}
 */
Cursor.prototype.setOption = function(field, value, cb) {
  var err = undefined
  try {
    var curs = new Cursor(this._cursor.setCursorOption(field, value))
  } catch (e) {
    if (!cb) {
      throw e
    }
 ...
 * @return {Cursor}
 */
Cursor.prototype.skip = function(value, cb) {
  var err = undefined
  try {
    var curs = new Cursor(this._cursor.skip(value))
  } catch (e) {
    if (!cb) {
      throw e
    }
