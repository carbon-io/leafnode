...
DB.prototype.getCollections = function() {
  var self = this
  return _.map(sync(this._nativeDB, 'collections', arguments), function(collection) {
...
DB.prototype.createCollection = function(name, options) {
  return new Collection(this, sync(this._nativeDB, 'createCollection', arguments))
},
...
DB.prototype.getCollection = function(name, options) {
  return new Collection(this, sync(this._nativeDB, 'collection', arguments))
}
...
DB.prototype.stats = function(options) {
  return sync(this._nativeDB, 'stats', arguments)
}
...
DB.prototype.close = function(force) {
    return sync(this._nativeDB, 'close', arguments)
}
