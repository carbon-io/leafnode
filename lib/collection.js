...
Collection.prototype.updateObject = function(doc, update, options) {
  ...
  return sync(this._collection, 'updateOne', [{_id: doc._id}, update, options]).modifiedCount
}
...
Collection.prototype.updateObjects = function(docs, update, options) {
  ...
  return sync(this._collection, 'updateMany', [query, update, options]).modifiedCount
}
...
Collection.prototype.deleteObject = function(doc, options) {
  ...
  return sync(this._collection, 'deleteOne', arguments).deletedCount
}
...
Collection.prototype.deleteObjects = function(docs, options) {
  ...
  query._id['$in'] = _.map(query._id['$in'], '_id')
  return sync(this._collection, 'deleteMany', [query, options]).deletedCount
}
